 ...
 * matching query param is present, see that route's own comment).
 */
 ...
 * philosophy and backend convention as backtestTriggerForm above
 * (src/index.js's /backfill route now reads these exact field names
